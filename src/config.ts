...
export const BOT_CONFIG = {
  ...
  ORDER_CONFIG: [
    { price: 0.48, size: 10,  expirationBuffer: 540 },  // 10 мин до старта (600-60)
    { price: 0.47, size: 14,  expirationBuffer: 300 },  // 6 мин до старта (360-60)
    { price: 0.46, size: 18,  expirationBuffer: 60 },   // 2 мин до старта (120-60)
    { price: 0.45, size: 25, expirationBuffer: -30 },  // 30 сек до старта (30-60)
    { price: 0.44, size: 25, expirationBuffer: -58 },  // 1 сек до старта (1-60)
    { price: 0.43, size: 25, expirationBuffer: -58 },  // 1 сек до старта (1-60)
    { price: 0.42, size: 25, expirationBuffer: -58 },  // 1 сек до старта (1-60)
  ],
