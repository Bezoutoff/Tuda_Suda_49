...
2. **Delay** — ждёт 19 сек (маркет активируется ~25 сек после создания)
3. **Pre-sign** — подписывает 1 ордер (UP @ 0.45)
4. **Spam** — отправляет 20 параллельных POST запросов до успеха
5. **Results** — выводит статистику latency
