...
|------|--------|------------|---------|
| 0.49 | $5 | за 10 мин до старта | UP + DOWN |
| 0.48 | $7 | за 6 мин до старта | UP + DOWN |
| 0.47 | $8 | за 2 мин до старта | UP + DOWN |
| 0.46 | $9 | за 30 сек до старта | UP + DOWN |
| 0.45 | $10 | за 1 сек до старта | UP + DOWN |

**Итого:** $78 на маркет (UP + DOWN)
...
|---------|--------|-------------|
| < 300ms | Отлично | Близко к серверам Polymarket (США) |
| 300-500ms | Хорошо | Нормальное соединение |
| 500-800ms | Средне | Далеко от серверов или медленный интернет |
| > 800ms | Плохо | Рекомендуется VPS ближе к США |
